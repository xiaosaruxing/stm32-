...
void  OLED_ShowNums(u8 x,u8 y,u32 num,u8 len,u8 size2)
{
	int i,j,k;
 for(i=0;i<len;i++)
 {
	 ...
	 for(j=0;j<len-i-1;j++)
			k=k*10;
 OLED_ShowNum( x+i*10, y,num/k%10,1,size2);
 }
}
void OLED_SHOW_A()
{
	  ...
	  OLED_ShowCN(0,0,4);   //智
	  OLED_ShowCN(35,0,5); //能
		OLED_ShowCN(70,0,6); //台
		OLED_ShowCN(105,0,7); //灯
	
	  OLED_ShowCN(0,2,2);   //光
	  OLED_ShowCN(20,2,3); //强
	 OLED_ShowCN(0,4,0);   //距
	 OLED_ShowCN(20,4,1);  //离
	 
		OLED_ShowCN(80,2,8);  //有
	  OLED_ShowCN(100,2,10); //人
		OLED_ShowCN(80,4,13);//手13
		OLED_ShowCN(100,4,12);//动12
	  OLED_ShowCN(0,6,14); //时14
		OLED_ShowCN(20,6,15);//间15
}
